...
/**
 * CountDownLath - это синхронизатор который позволяет любому количеству потоков ожидать пока не
 * завершится определенное количество операций
 * <p>
 * Допустим мы устраиваем гонки у нас есть 5 автомобилей, и 3 сигнала перед стартом и того 8 условий
 * которые нам нужно дождаться прежде чем начнется гонка
 */
public class CountDownLatchEx {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while (START.getCount() > 3) { //Проверяем, собрались ли все автомобили у стартовой прямой. Если нет, ждем 100ms
            Thread.sleep(100);
        }
