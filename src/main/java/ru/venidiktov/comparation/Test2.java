...
public class Test2 {
    public static void main(String[] args) {
        ...
        System.out.println("list1 до сортировки = " + employees); //list1 до сортировки = [Employee{'Ivan', 'Maria', 'Iosif'}]
        Collections.sort(employees);
        System.out.println("list1 после сортировки = " + employees); //list1 после сортировки = [Employee{'Maria', 'Ivan', 'Iosif'}]
